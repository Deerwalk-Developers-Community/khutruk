    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-[588px] relative bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="h-8 px-3 py-1.5 bg-gray-200 inline-flex items-center">
          <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight">Step {step}:</div>
        </div>
        <div className="w-full p-6">
          <form onSubmit={handleSubmit(step === 1 ? onSubmitStep1 : step === 2 ? onSubmitStep2 : onSubmitStep3)}>
            {step === 1 && (
              <>
                <div className="text-slate-900 text-sm font-normal font-['Inter'] leading-tight mb-6">Create Project Overview</div>
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Where will the fund go?</div>
                ...
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Zip Code</div>
                  <input
                ...
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Select a Category for your Fund Raising</div>
                  <div className="relative">
                    <select
            ...
            {step === 2 && (
              <>
                <div className="text-slate-900 text-sm font-normal font-['Inter'] leading-tight mb-6">Introduction to your Campaign</div>
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Project Name</div>
                  <input
                ...
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Project Description</div>
                  <textarea
                ...
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Add a Thumbnail image</div>
                  <div className="w-full h-[121px] bg-[#bbf6d0] rounded-[9px] flex items-center justify-center cursor-pointer">
                    <input
                      ...
                      id="thumbnail"
                    />
                    <label htmlFor="thumbnail" className="text-slate-900 text-sm font-normal font-['Inter'] leading-tight cursor-pointer">
                      Upload your Image
                    </label>
                  </div>
                  {ipfsHash && <p className="text-green-500 text-xs mt-1">Image uploaded successfully!</p>}
                </div>
              </>
            )}
            {step === 3 && (
              <>
                <div className="text-slate-900 text-sm font-normal font-['Inter'] leading-tight mb-6">Your Estimated Goal</div>
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">In NPR</div>
                  <div className="relative">
                    <input
                  ...
                  {errors.targetAmount && <p className="text-red-500 text-xs mt-1">{errors.targetAmount.message as string}</p>}
                </div>
                <div className="mb-6">
                  <div className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight mb-1.5">Deadline</div>
                  <input
                ...
                {errors.acceptTerms && <p className="text-red-500 text-xs mb-4">{errors.acceptTerms.message as string}</p>}
              </>
            )}
            <button
              type="submit"
